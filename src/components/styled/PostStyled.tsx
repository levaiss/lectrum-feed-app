...
export const PostStyled: IStyledComponent<any, any> = styled.section`
  position: relative;
  margin: 0 auto;
  padding: 15px;
  ...
  & .comment {
    ...
    &.comment-fill .comment-icon {
      fill: var(--paletteColor5);

      path {
        stroke: var(--paletteColor5);
      }
    }
  ...
  & .commentBody {
    border-bottom: 1px solid var(--paletteColor10);
    padding-bottom: 10px;
